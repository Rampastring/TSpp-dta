...
typedef enum TEventType {
    ...
    TEVENT_ENEMY_IN_SPOTLIGHT,              // Check if spotlight illuminates enemy unit
...
typedef enum TActionType {
    ...
    TACTION_TURN_OFF_ATTACHED,
    TACTION_TURN_ON_ATTACHED,
    TACTION_DAMAGE,
    TACTION_LIGHT_SMALL,
    ...
    TACTION_BEGIN_AI_TRIGGERS,
    TACTION_STOP_AI_TRIGGERS,
    ...
    TACTION_REINFORCEMENTS_SPECIAL,
    TACTION_WAKEUP_SELF,
    TACTION_WAKEUP_ALL_SLEEP,
    ...
    TACTION_REMOVE_PARTICLE_ANIM,
    TACTION_ION_LIGHTNING_STRIKE,
    TACTION_GO_BERZERK,
    TACTION_ACTIVATE_FIRESTORM,
    TACTION_DEACTIVATE_FIRESTORM,
    TACTION_ION_CANNON,
    TACTION_MULTI_MISSILE,
    TACTION_CHEM_MISSILE,
    TACTION_TOGGLE_TRAIN_CARGO,
    TACTION_PLAY_SOUND_RANDOM,
    TACTION_PLAY_SOUND_AT,
